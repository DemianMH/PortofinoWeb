...
// --- Iconos para platos especiales ---
const SpicyIcon = () => <span title="Spicy">🌶️</span>;
const GlutenFreeIcon = () => <span title="Gluten-Free Option Available">🌿</span>;


// --- Tipos para los datos del menú ---
type MenuItem = {
    name: string;
    price: string;
    description?: string;
...
// --- Datos del Menú COMPLETOS (transcritos de todas las imágenes) ---
const menuData: MenuCategory[] = [
    {
        category: "Appetizers",
        items: [
            { name: "Garlic Cheese Bread", price: "5.99" }, //
            { name: "Italian Sausage", description: "Sliced w/spicy marinara", price: "9.99" }, //
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Pasta Primavera", description: "Mushrooms, broccoli, onions, green peppers, red peppers, artichokes, tomatoes and spinach w/alla panna served over fettuccine", price: "16.99", icon: <GlutenFreeIcon /> } //
        ],
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Lobster Ravioli", description: "Four lobster stuffed ravioli shells w/alla panna sauce", price: "20.99" }, //
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Pomodoro", description: "Fresh tomatoes, basil, sherry wine w/light marinara sauce served over ziti", price: "15.99", icon: <GlutenFreeIcon /> }, //
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-500">Authentic Italian dishes made with the freshest ingredients.</p>
        </div>

        {menuData.map((category) => (
          <div key={category.category} className="mb-12">
            <h2 className="text-3xl font-bold text-center text-red-700 mb-4 font-serif">{category.category}</h2>
            {category.note && !category.items.length && <p className="text-center text-gray-500 mt-2 text-sm italic">{category.note}</p>}
            ...
            {category.note && category.items.length > 0 && <p className="text-center text-gray-500 mt-6 text-sm italic">{category.note}</p>}
          </div>
        ))}
      </div>
    </div>
